...
extern Task sound_measure_task;
...
// sound measure
void sound_measure() {
  int sound_measure = analogRead(sound_pin);
  Serial.print("loudness measured:");
  Serial.println(sound_measure);
}
//the task
Task sound_measure_task(100, TASK_FOREVER, &sound_measure);
...
void setup() {
  ...
  button_task.enable();
  runner.addTask(sound_measure_task);
  sound_measure_task.enable();
